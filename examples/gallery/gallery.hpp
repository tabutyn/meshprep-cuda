...
// initialization. Soft-body recipes require the converted cylinder `.msb`
// asset; cloth, rope, fluid, rigid, and smoke owners generate their own state.
struct GallerySimulationOptions {
    ...
    std::optional<std::uint32_t> substeps_override{};
...
class SimulationBuilder {
  public:
    ...
    SimulationBuilder &substeps(std::uint32_t value) noexcept;
